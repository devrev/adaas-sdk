...
import { withLocalTraceResult } from '../tracing/local-trace';
...
export class Uploader {
  ...
  async getArtifactUploadUrl(
    ...
    return withLocalTraceResult(
      'Uploader.getArtifactUploadUrl',
      {
        ...
        source: {
          file: __filename,
          symbol: 'Uploader.getArtifactUploadUrl',
        },
      },
      async () => {
  ...
  async uploadArtifact(
    ...
    return withLocalTraceResult(
      'Uploader.uploadArtifact',
      {
        ...
        source: {
          file: __filename,
          symbol: 'Uploader.uploadArtifact',
        },
      },
      async () => {
  ...
  async streamArtifact(
    ...
    return withLocalTraceResult(
      'Uploader.streamArtifact',
      {
        attributes: {
          upload_url: artifact.upload_url,
          has_content_length: Boolean(fileStream.headers['content-length']),
        },
        source: {
          file: __filename,
          symbol: 'Uploader.streamArtifact',
        },
      },
      async () => {
        const formData = new FormData();
  ...
  async confirmArtifactUpload(artifactId: string): Promise<{
    ...
    return withLocalTraceResult(
      'Uploader.confirmArtifactUpload',
      {
        attributes: {
        ...
        source: {
          file: __filename,
          symbol: 'Uploader.confirmArtifactUpload',
        },
      },
      async () => {
  ...
  async getAttachmentsFromArtifactId({
    ...
    return withLocalTraceResult(
      'Uploader.getAttachmentsFromArtifactId',
      {
        attributes: {
        ...
        source: {
          file: __filename,
          symbol: 'Uploader.getAttachmentsFromArtifactId',
        },
      },
      async () => {
        ...
        const { response: jsonlObject, error: jsonlObjectError } =
  ...
  private async getArtifactDownloadUrl(
    ...
    return withLocalTraceResult(
      'Uploader.getArtifactDownloadUrl',
      {
        ...
        source: {
          file: __filename,
          symbol: 'Uploader.getArtifactDownloadUrl',
        },
      },
      async () => {
  ...
  private async downloadArtifact(
    ...
    return withLocalTraceResult(
      'Uploader.downloadArtifact',
      {
        ...
        source: {
          file: __filename,
          symbol: 'Uploader.downloadArtifact',
        },
      },
      async () => {
        try {
  ...
  async getJsonObjectByArtifactId({
    ...
    return withLocalTraceResult(
      'Uploader.getJsonObjectByArtifactId',
      {
        attributes: {
          artifact_id: artifactId,
        ...
        source: {
          file: __filename,
          symbol: 'Uploader.getJsonObjectByArtifactId',
        },
      },
      async () => {
        const { response: artifactUrl, error: artifactUrlError } =
        ...
        if (isGzipped) {
          ...
          const jsonlObject = Buffer.from(decompressedArtifact!).toString(
            'utf-8'
          );
