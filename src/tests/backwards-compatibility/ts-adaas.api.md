...
// @public
export function createAdapter<ConnectorState>(
  event: AirdropEvent,
  initialState: ConnectorState,
  isLocalDevelopment?: boolean
): Promise<Adapter<ConnectorState>>;
...
// @public (undocumented)
export function installInitialDomainMapping(
  event: AirdropEvent,
...
export function processTask<ConnectorState>({
  task,
  onTimeout,
}: ProcessTaskInterface<ConnectorState>): void;
...
// @public
export function spawn<ConnectorState>({
  event,
  initialState,
  workerPath,
