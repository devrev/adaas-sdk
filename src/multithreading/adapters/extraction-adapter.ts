 ...
 * extraction surface (repos, artifacts, attachment streaming) and updates the
 * extraction boundaries before emitting.
 *
 * @public
 */
export class ExtractionAdapter<ConnectorState> extends BaseAdapter<
  ConnectorState,
  ExtractionState<ConnectorState>
> {
