 ...
 * @param {number=} maxAttachmentFailures - Number of times an attachment may fail with a transient
 * upload error (ECONNABORTED, 5xx) before it is permanently skipped across invocations
 */
