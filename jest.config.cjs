  ...
  projects: [
    ...
    },
    {
      ...
      testMatch: [
        ...
        '<rootDir>/src/tests/partial-load-failure/partial-load-failure.test.ts',
        '<rootDir>/src/tests/state-atomicity/post-state-failure.test.ts',
        '<rootDir>/src/tests/attachment-stream-leak/stream-leak.test.ts',
      ],
    },
  ],
};
